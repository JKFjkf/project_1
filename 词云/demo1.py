...
if __name__ == '__main__':
    d = path.dirname(r"C:\Users\hp\Desktop\python\?")              # 获取当前文件路径
    fontname = path.join(d, 'font1.ttf')     # 中文字体路径
    filename = path.join(d, 'kuangren.txt')      # txt文件路径
    imagename = path.join("circle.jpg")  # 背景图片路径
